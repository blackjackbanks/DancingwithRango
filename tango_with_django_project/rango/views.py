...
def index(request):
    # List of all categories stored, top 5 desc. Add list to dictionary
    category_list = Category.objects.order_by('-likes')[:5]
    context_dict = {'boldmessage': 'Crunchy, creamy, cookie, candy, cupcake!'}
    context_dict['categories'] = category_list

    # List of all pages stored, top 5 desc. Add list to dictionary
...
def about(request):
    context_dict = {'mymessage': 'You got it and keep it up'}
...
def show_category(request, category_name_slug):
    ...
    try:
        ...
        # the database to the context database
...
def user_login(request):
    ...
    if request.method == 'POST':
        ...
        if user:
            # Is the acccount active? It could have been disabled.
            if user.is_active:
